...
- **[smb-second-brain](https://github.com/SMBexcel/free-ai-tools/tree/main/claude-skills/smb-second-brain)** `v1.0` — Turn a folder of docs into an LLM-maintained wiki you can ask questions, with citations. Opens in Obsidian as-is; one script publishes it as a 3D knowledge graph. No database, no embeddings.
